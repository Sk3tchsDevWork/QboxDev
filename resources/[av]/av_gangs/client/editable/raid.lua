...
function isCop() -- check if player at door is cop
    ...
    dbug("isCop(), ".."job:"..job..", grade: "..grade)
...
function extraChecks(gang,isCop,level)
    dbug("extraChecks()", gang, isCop, level)
